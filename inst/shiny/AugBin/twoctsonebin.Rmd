...
$$\begin{aligned}
Y_{i1}&=\alpha_{0}+\alpha_{1}T_{i}+\alpha_{2}y_{i10}+\varepsilon_{i1}\\\\ Y_{i2}&=\beta_{0}+\beta_{1}T_{i}+\beta_{2}y_{i20}+\varepsilon_{i2}\\\\ Y_{i3}^{*}&=\gamma_{0}+\gamma_{1}T_{i}+\varepsilon_{i3}^{*}
\end{aligned}$$
