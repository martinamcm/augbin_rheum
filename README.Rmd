...
Implementation as a Shiny app with further documentation on functionality and examples available at [AugBin](https://github.com/martinamcm/AugBin)

## Details 

Function `augbinrheum` is used to conduct the analysis with the following arguments: 

* `Data` Data with columns ordered as follows: patient ID, treatment arm, continuous outcome(s), 
binary outcome followed by the baseline continuous measure(s)
...
* `dichot` Responder threshold in each of the continuous outcomes. For one continuous outcome 
input as 'd1' and for two continuous outcomes input as 'c(d1,d2)'
